...
nexusMetadata=`curl -s -L "http://192.168.1.31:8082/nexus/service/local/repositories/releases/content/com/amhzing/turbine/turbine-microservice/maven-metadata.xml"`
